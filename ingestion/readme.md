...
##### Country names for [Geofabrik array](https://github.com/mansueto-institute/kblock/blob/build-update-2/ingestion/download_job.sh#L24) argument
```
...
##### Country codes for [GADM array](https://github.com/mansueto-institute/kblock/blob/build-update-2/ingestion/download_job.sh#L25) argument
