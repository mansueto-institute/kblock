...
```
#### How to run ingestion job and write to download directory
```
cd /users/repos/
...
##### Potential country codes for GADM array (see download_job.sh)
```
...
##### Potential country names for Geofabrik array (see download_job.sh)
```
