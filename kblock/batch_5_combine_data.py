...
def main(log_file: Path, country_chunk: list, blocks_dir: Path, population_dir: Path, buildings_dir: Path, complexity_dir: Path, streets_dir: Path, crosswalks_dir: Path, output_dir: Path):
    ...
    if (africa_files_exist is not True):
        ...
        map_col_list = ['block_id', 'block_geohash', 'area_type', 'urban_center_name', 'country_name', 'agglosname', 'k_complexity', 'k_labels', 'k_labels_detailed', 'landscan_population_un', 'landscan_population_un_log', 'landscan_population_un_density_hectare', 'landscan_population_un_density_hectare_log', 'worldpop_population_un', 'worldpop_population_un_log', 'worldpop_population_un_density_hectare', 'worldpop_population_un_density_hectare_log', 'block_hectares', 'building_count', 'average_building_area_m2', 'building_to_block_area_ratio', 'geometry']
