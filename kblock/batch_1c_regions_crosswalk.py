...
def main(log_file: Path, country_chunk: list, africapolis_file: Path, ghsl_file: Path, gadm_dir: Path, blocks_dir: Path, output_dir: Path):
    ...
    if len(country_list) > 0:
        ...
        africapolis_data['agglosid'] = 'africapolis_' + africapolis_data['agglosid'].astype(int).astype(str)
        ...
        # Urban delineations
        full_xwalk.loc[full_xwalk['area_type'].isin(['Non-urban']), "urban_layer_code"] = full_xwalk['country_code'] + '_nonurban'
    ...
    if len(country_list_regions) > 0:
        ...
        for country_code in full_xwalk['country_code'].unique():
            ...
            regions['urban_layer_code'] = regions['country_code'] + '_nonurban'
