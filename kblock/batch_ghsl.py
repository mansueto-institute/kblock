...
def main(log_file: Path, ghsl_file: Path, country: str, blocks_dir: Path, output_dir: Path, ancillary_dir: Path) -> None:
...
def setup(args=None):	
	...
	parser.add_argument('--country', required=True, type=str, dest='country', help='ISO-3 country code')
